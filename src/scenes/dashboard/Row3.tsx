...
const Row2 = () => {
  ...
  const operationalExpenses = useMemo(() => {
    return (
      operationalData && operationalData[0].monthlyData.map(monthData => {
        return {
          name: monthData.month.substring(0, 3),
          "Operational Expenses": monthData.operationalExpenses,
          "Non Operational Expenses": monthData.nonOperationalExpenses
        };
      })
    );
  }, [operationalData]);
